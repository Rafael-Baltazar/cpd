...
time ./wolves-squirrels-serial tests/ex3.in 500 500 1000 1000000 > tests/out_serial

echo " "

# Run parallel version
echo "Parallel version"
time ./wolves-squirrels-parallel tests/ex3.in 500 500 1000 1000000 > tests/out_parallel
